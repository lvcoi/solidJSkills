...
This document provides technical details about how solidJSkills is structured and wired together. If you're just looking to use the project, head back to the [main README](../README.md).
