...
## [Configuring TypeScript](typescript.md#configuring-typescript)
...
## [Migrating from JavaScript to TypeScript](typescript.md#migrating-from-javascript-to-typescript)
...
## [API types](typescript.md#api-types)
...
#### [Default values](typescript.md#default-values)
...
Much like [default values](typescript.md#default-values) in signals, `| undefined` can be avoided in the type by giving a default value that will be returned if no value is assigned by a context provider:
...
### [Components](typescript.md#components)

#### [The basics](typescript.md#the-basics)
...
#### [Components with props](typescript.md#components-with-props)
...
#### [Components with children](typescript.md#components-with-children)
...
#### [Special component types](typescript.md#special-component-types)
...
- **FlowComponent:** Designed for components like [`<Show>`](../reference/components/show.md) or [`<For>`](../reference/components/for.md), typically requiring children and, occasionally, specific children types.

These types make sure that the children fit the required type, maintaining consistent component behaviour.

##### [Components without the `Component` types](typescript.md#components-without-the-component-types)
...
### [Event handling](typescript.md#event-handling)

#### [Basics](typescript.md#basics)
...
#### [Inline handlers](typescript.md#inline-handlers)
...
#### [`currentTarget` and `target`](typescript.md#currenttarget-and-target)
...
### [`ref` attribute](typescript.md#ref-attribute)

#### [Basics](typescript.md#basics-1)
...
## [Control flow-based narrowing](typescript.md#control-flow-based-narrowing)
...
## [Advanced JSX attributes and directives](typescript.md#advanced-jsx-attributes-and-directives)

### [Custom event handlers](typescript.md#custom-event-handlers)
...
#### [Forcing properties and custom attributes](typescript.md#forcing-properties-and-custom-attributes)
...
#### [Custom directives](typescript.md#custom-directives)
...
##### [Addressing import issues with directives](typescript.md#addressing-import-issues-with-directives)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve%20documentation%2Cpending%20review&projects=&template=CONTENT.yml&title=%5BContent%5D%3A&subject=%2Fconfiguration%2Ftypescript.mdx&page=https%3A%2F%2Fdocs.solidjs.com%2Fconfiguration%2Ftypescript)
