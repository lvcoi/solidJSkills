...
## [Options](create-deferred.md#options)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve%20documentation%2Cpending%20review&projects=&template=CONTENT.yml&title=%5BContent%5D%3A&subject=%2Freference%2Fsecondary-primitives%2Fcreate-deferred.mdx&page=https%3A%2F%2Fdocs.solidjs.com%2Freference%2Fsecondary-primitives%2Fcreate-deferred)

Previous[← createComputed](create-computed.md)

Next[createReaction →](create-reaction.md)
