...
## [Arguments](index-array.md#arguments)

NameTypeDescriptionlist`() => readonly T[]`The list to map.mapFn`(v: () => T, i: number) => U`The mapping function.

[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve%20documentation%2Cpending%20review&projects=&template=CONTENT.yml&title=%5BContent%5D%3A&subject=%2Freference%2Freactive-utilities%2Findex-array.mdx&page=https%3A%2F%2Fdocs.solidjs.com%2Freference%2Freactive-utilities%2Findex-array)

Previous[← getOwner](get-owner.md)

Next[mapArray →](map-array.md)
