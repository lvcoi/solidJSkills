...
## [How sessions work](session.md#how-sessions-work)
...
Most of these steps are automatically managed by the [session helpers](session.md#session-helpers).
...
## [Session helpers](session.md#session-helpers)
...
## [Creating a session](session.md#creating-a-session)
...
## [Getting the session data](session.md#getting-the-session-data)
...
## [Updating the session data](session.md#updating-the-session-data)
...
## [Clearing the session data](session.md#clearing-the-session-data)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve%20documentation%2Cpending%20review&projects=&template=CONTENT.yml&title=%5BContent%5D%3A&subject=%2Fsolid-start%2Fadvanced%2Fsession.mdx&page=https%3A%2F%2Fdocs.solidjs.com%2Fsolid-start%2Fadvanced%2Fsession)

Previous[← Middleware](middleware.md)

Next[Request events →](request-events.md)
