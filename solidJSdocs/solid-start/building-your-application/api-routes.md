...
For these use cases, SolidStart provides a way to write these routes in a way that is easy to understand and maintain. API routes are just similar to other routes and follow the same filename conventions as [UI Routes](routing.md).
...
## [Writing an API route](api-routes.md#writing-an-api-route)
...
## [Session management](api-routes.md#session-management)
...
In this example, you can see that the `userId` is read from the cookie and then used to look up the user in the store. For more information on how to use cookies for secure session management, read the [session documentation](../advanced/session.md).

* * *

## [Exposing a GraphQL API](api-routes.md#exposing-a-graphql-api)
...
## [Exposing a tRPC server route](api-routes.md#exposing-a-trpc-server-route)
...
[Report an issue with this page](https://github.com/solidjs/solid-docs-next/issues/new?assignees=ladybluenotes&labels=improve%20documentation%2Cpending%20review&projects=&template=CONTENT.yml&title=%5BContent%5D%3A&subject=%2Fsolid-start%2Fbuilding-your-application%2Fapi-routes.mdx&page=https%3A%2F%2Fdocs.solidjs.com%2Fsolid-start%2Fbuilding-your-application%2Fapi-routes)

Previous[← Routing](routing.md)

Next[CSS and styling →](css-and-styling.md)
